...
$boleto = new VinicciusGuedes\LaravelCnab\Boleto\Banco\Itau([
    ...
    'qr_code_style'          => VinicciusGuedes\LaravelCnab\Boleto\Banco\Itau::QRCODE_ESTILO_PONTO,
]);

$pdf = new VinicciusGuedes\LaravelCnab\Boleto\Render\Pdf();
$pdf->addBoleto($boleto);
$pdf->setLocalizacaoPix(VinicciusGuedes\LaravelCnab\Boleto\Render\Pdf::PIX_INSTRUCAO);
//$pdf->setLocalizacaoPix(VinicciusGuedes\LaravelCnab\Boleto\Render\Pdf::PIX_COD_BARRAS);
