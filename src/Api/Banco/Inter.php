<?php
namespace VinicciusGuedes\LaravelCnab\Api\Banco;

use Carbon\Carbon;
use VinicciusGuedes\LaravelCnab\Api\AbstractAPI;
...
class Inter extends AbstractAPI
{
     ...
     * @throws \VinicciusGuedes\LaravelCnab\Api\Exception\CurlException
     * @throws \VinicciusGuedes\LaravelCnab\Api\Exception\HttpException
     * @throws \VinicciusGuedes\LaravelCnab\Api\Exception\UnauthorizedException
     */
     ...
     * @param $boleto
     *
     * @return \VinicciusGuedes\LaravelCnab\Boleto\Banco\Inter
     * @throws \Exception
     */
    private function arrayToBoleto($boleto)
    {
        return \VinicciusGuedes\LaravelCnab\Boleto\Banco\Inter::fromAPI($boleto, [
            'conta'        => $this->getConta(),
